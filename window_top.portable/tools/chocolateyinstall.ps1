...
$url        = 'http://windowtop.info/wp-content/uploads/2017/10/v1.9.1-64bit-Including-portable-version.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'window_top.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
