...
$url        = 'https://releases.hashicorp.com/packer/1.2.5/packer_1.2.5_windows_amd64.zip' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'packer*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
